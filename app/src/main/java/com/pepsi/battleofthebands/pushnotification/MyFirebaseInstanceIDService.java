...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    public void onTokenRefresh() {
        ...
        sendBroadcast(new Intent(MainActivity.TAG_TOKEN).putExtra("token", refreshedToken));
...
//                String newToken = instanceID.getToken("965668593146", GoogleCloudMessaging.INSTANCE_ID_SCOPE, null);
